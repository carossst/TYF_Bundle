// resourceManager.js - Version directe (sans requêtes réseau)
// Cette version utilise DIRECTEMENT les données intégrées sans essayer de charger les fichiers
...
window.ResourceManager = (function() {
  ...
  ResourceManagerClass.prototype.loadMetadata = async function() {
    ...
    console.log("⚠️ UTILISATION DIRECTE DES DONNÉES INTÉGRÉES - AUCUNE REQUÊTE RÉSEAU");
    ...
    console.log("✅ Using embedded metadata directly");
  ...
  ResourceManagerClass.prototype.getQuiz = async function(themeId, quizId) {
    ...
    console.log(`⚠️ CRÉATION D'UN QUIZ FACTICE POUR THÈME ${themeId}, QUIZ ${quizId}`);
    
    // Création d'un quiz factice
    const quizData = {
      id: Number(quizId),
      ...
      questions: [
        {
          question: "Ceci est une question factice générée par le code de secours. Sélectionnez n'importe quelle réponse.",
          options: ["Option A", "Option B", "Option C", "Option D"],
          correctAnswer: "Option A",
          explanation: "Ceci est une explication factice."
        },
        {
          question: "Deuxième question factice. Choisissez n'importe quelle option.",
          options: ["Choix 1", "Choix 2", "Choix 3"],
          correctAnswer: "Choix 2",
          explanation: "Explication pour la question 2."
        }
      ]
    };
    ...
    console.log(`✅ Quiz factice créé pour ${quizId} (Theme ${themeId})`);
    return quizData;
  };
  ...
  ResourceManagerClass.prototype.preloadThemeQuizzes = async function(themeId) {
    ...
    try {
      ...
      // Nous ne préchargeons rien, car tout est généré à la demande
      console.log(`✅ Preloading complete for theme ${themeId} (mode factice)`);
    } catch (error) {
